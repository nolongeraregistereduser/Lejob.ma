    ...
    <main>
        ...
        <section class="px-6 py-20 bg-gray-50">
            ...
            <div class="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                <!-- Phone -->
                <div class="bg-white p-8 rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 text-center group">
                    ...
                    <p class="text-gray-600 mb-6">+212 5 22 98 76 54</p>
                    <a href="tel:+212522987654" class="inline-block bg-gray-900 text-white px-8 py-3 rounded-full hover:bg-gray-800 transition-colors w-full">Appeler</a>
                </div>
                ...
                <div class="bg-white p-8 rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 text-center group">
                    ...
                    <p class="text-gray-600 mb-6">contact@lejob.ma</p>
                    <a href="mailto:contact@lejob.ma" class="inline-block bg-gray-900 text-white px-8 py-3 rounded-full hover:bg-gray-800 transition-colors w-full">Écrire</a>
                </div>
                ...
                <div class="bg-white p-8 rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 text-center group">
                    ...
                    <p class="text-gray-600 mb-6">123 Rue des Fleurs,<br>Casablanca 20000</p>
                    <a href="#" class="inline-block bg-gray-900 text-white px-8 py-3 rounded-full hover:bg-gray-800 transition-colors w-full">Visiter</a>
                </div>
                ...
                <div class="bg-white p-8 rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 text-center group">
                    ...
                    <p class="text-gray-600 mb-6">Du Lundi au Vendredi<br>9h - 18h</p>
                    <a href="#" class="inline-block bg-gray-900 text-white px-8 py-3 rounded-full hover:bg-gray-800 transition-colors w-full">Nous contacter</a>
                </div>
            </div>
        </section>
    </main>
