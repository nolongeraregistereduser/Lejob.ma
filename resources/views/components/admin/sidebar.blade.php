<div class="bg-black w-64 flex flex-col h-screen fixed left-0 top-0">
    ...
    <nav class="flex-1 px-2 py-4">
        ...
        <a href="{{ route('admin.jobs') }}" class="flex items-center px-4 py-2 text-white hover:bg-gray-800 rounded-lg mb-1 {{ request()->routeIs('admin.jobs') ? 'bg-gray-800' : '' }}">
            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a href="{{ route('admin.feedback.index') }}" class="flex items-center px-4 py-2 text-white hover:bg-gray-800 rounded-lg mb-1 {{ request()->routeIs('admin.feedback.*') ? 'bg-gray-800' : '' }}">
            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z"></path>
            </svg>
            Avis Clients
        </a>
        <a href="{{ route('admin.statistics') }}" class="flex items-center px-4 py-2 text-white hover:bg-gray-800 rounded-lg mb-1 {{ request()->routeIs('admin.statistics') ? 'bg-gray-800' : '' }}">
            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
