<div class="bg-black w-64 flex flex-col h-screen fixed left-0 top-0">
    ...
    <nav class="flex-1 px-2 py-4">
        ...
        <a href="#" class="flex items-center px-4 py-2 text-white hover:bg-gray-800 rounded-lg mb-1">
            <a href="{{ route('admin.interviews') }}" class="flex items-center px-4 py-2 text-white hover:bg-gray-800 rounded-lg mb-1 {{ request()->routeIs('admin.interviews') ? 'bg-gray-800' : '' }}">
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
