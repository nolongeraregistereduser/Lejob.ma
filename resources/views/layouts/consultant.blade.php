        ...
        <nav class="bg-white border-b border-gray-200">
            ...
            <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
                <div class="pt-2 pb-3 space-y-1">
                    ...
                    <a href="" class="block pl-3 pr-4 py-2 border-l-4 {{ request()->routeIs('consultant.analytics') ? 'border-indigo-500 text-indigo-700 bg-indigo-50' : 'border-transparent text-gray-600 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-800' }} text-base font-medium">
                        Statistiques
                    </a>
